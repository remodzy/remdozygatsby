    ...
    isMobile ? (
      ...
      >
        <path
          ...
          fill='url(#ServiceIconPaint0Linear)'
        />
        <defs>
          <linearGradient
            id='ServiceIconPaint0Linear'
            x1='-5.253'
            y1='-2.679'
            x2='79.029'
            y2='73.577'
    ...
    isMobile ? (
      ...
      >
        <path
          ...
          fill='url(#FormsPaint0Linear)'
        />
        <defs>
          <linearGradient
            id='FormsPaint0Linear'
            x1='-5.253'
            y1='-2.679'
            x2='79.029'
            y2='73.577'
...
const DesktopProductListMenuItems: React.FC<MenuProps> = ({ list }) => (
  <>
    {list.map(({ key, title, subTitle, iconName, link }) => (
